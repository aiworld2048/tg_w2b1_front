...
const Deposit = () => {
  ...
  const deposit = async (e) => {
    e.preventDefault();
    const url = BASE_URL + "/depositfinicial";
    const inputData = {
  ...
  return (
      <div>
        ...
        >
          <div className="d-flex justify-content-between">
            ...
            <div className="text-right">
              <button
                  type="button"
                  className="px-3 py-1 rounded-lg border border-yellow-400 text-yellow-400 bg-transparent hover:bg-yellow-400 hover:text-black transition mb-4"
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <img
                        ...
                        src={"https://ag.goldencitycasino123.site" + selectedBank.image}
                  ...
                  <button
                      type="button"
                      className="px-3 py-1 rounded-lg border border-white text-white bg-transparent hover:bg-white hover:text-black transition"
          ...
          <div className="row mb-2">
            ...
            <div className="col-span-7">
              <input
                  ...
                  value={amount}
              />
              {error?.amount && <span className='text-red-400 text-xs'>*{error.amount}</span>}
          ...
          <div className="row mb-2">
            ...
            <div className="col-span-7">
              <input
                  ...
                  value={refrence_no}
              />
              {error?.refrence_no && <span className='text-red-400 text-xs'>*{error.refrence_no}</span>}
            </div>
          </div>
        ...
        {show && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 animate-fadeIn" style={{  backgroundColor: 'rgba(0,0,0,0.7)'}}>
              <div className="bg-white rounded-2xl shadow-2xl p-4 w-full max-w-xs relative">
                ...
                <div className="space-y-2 mb-4">
                  {banks?.map((bank, index) => (
                      ...
                      >
                        <img src={"https://ag.goldencitycasino123.site" + bank.image} className="w-10 h-10 rounded-md object-cover" alt="bank" />
                        <div>
