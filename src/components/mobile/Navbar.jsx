...
function Navbar() {
  ...
  return (
    <>
      <nav className="w-full z-30 sticky top-0 bg-[#021039] shadow-lg px-2 py-2 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}> 
          <img  src={'6tribet.jpg'} alt="Logo" className="h-9 w-auto object-contain" />
        </div>
        {/* Balances & Exchange */}
        {user && (
