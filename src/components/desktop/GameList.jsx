...
export function GameList({loading, games}) {
  ...
  background: 'linear-gradient(to right, #2155f0, #0a2472)'}}>
              <div className="w-full h-full bg-black/60 rounded-2xl flex items-center justify-center group-hover:bg-black/80 transition-all duration-200">
                ...
                />
                <button
                  className="absolute bottom-2 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-white font-bold text-xs shadow hover:scale-105 transition whitespace-nowrap border border-yellow-300"
                        style={{background: 'linear-gradient(to right, #63a3ff, #b6deff)'}}
  ...
  background: 'linear-gradient(to right, #63a3ff, #b6deff)'}}>
        ...
        {hasMore && !games && (
            <div className="text-center my-3">
              <button
            className="px-6 py-2 rounded-full bg-gradient-to-r text-black font-bold text-sm shadow hover:scale-105 transition"
            style={{ maxWidth: 200,background: 'linear-gradient(to right, #63a3ff, #b6deff)' }}
