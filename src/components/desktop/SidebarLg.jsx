    ...
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-80 max-w-full bg-[#181c2f] z-50 transition-transform duration-300 ${show ? 'translate-x-0' : 'translate-x-full'} flex flex-col`}>
        ...
        <div className="flex-1 overflow-y-auto flex flex-col items-center gap-1 ps-2 pe-2">
          <Link to={'/information?tab=profile'} onClick={onClose} className="flex items-center gap-3 w-full mt-1">
...
export default SidebarLg
  ...
  //               <img src={"https://www.delightmyanmar99.pro/api/../"+contact.image} className="rounded-lg w-12 h-12" alt={contact.name} />
  //             </Link>
  //           ))}
  //         </div>
