    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-4">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                {!loading && !error && data && data.latest_results && (
                    <div className="space-y-6">
                        {/* Latest Results */}
                        <div className="space-y-6">
                            <h2 className="text-2xl font-bold text-white text-center mb-6 flex items-center justify-center gap-3">
                ...
                {!loading && !error && (!data || !data.latest_results || data.latest_results.length === 0) && (
                    <div className="text-center py-20">
                        <FaTrophy className="text-6xl text-gray-500 mx-auto mb-4" />
                        <p className="text-gray-400 text-lg">No winners data available for the selected date and session</p>
                    </div>
                )}
            </div>
        </div>
